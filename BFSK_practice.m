...
phasecomponentforsymbolone = 2.*pi.*(frequencySeparation/2);
phasecomponentforsymbolzero = - 2.*pi.*(frequencySeparation/2);
...
modulatedsignal = amplitudecomponent*Vc .*sin((2*pi*fc + phasecomponent).*t);
